...
class Chan10_4M_HackRF(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Chan10_4M_HackRF")
        ...
        self.soapy_hackrf_source_0.set_frequency(0, 903.2e6)
        self.soapy_hackrf_source_0.set_gain(0, 'AMP', False)
        self.soapy_hackrf_source_0.set_gain(0, 'LNA', min(max(40, 0.0), 40.0))
        self.soapy_hackrf_source_0.set_gain(0, 'VGA', min(max(12, 0.0), 62.0))
        ...
        self.connect((self.blocks_correctiq_0, 0), (self.blocks_rotator_cc_0_0, 0))
        self.connect((self.blocks_correctiq_0, 0), (self.blocks_rotator_cc_0_0_0, 0))
        self.connect((self.blocks_correctiq_0, 0), (self.blocks_rotator_cc_0_0_0_0, 0))
        self.connect((self.blocks_correctiq_0, 0), (self.blocks_rotator_cc_0_0_0_1, 0))
        self.connect((self.blocks_correctiq_0, 0), (self.blocks_rotator_cc_0_0_0_1_0, 0))
        self.connect((self.blocks_correctiq_0, 0), (self.blocks_rotator_cc_0_0_0_1_1, 0))
        self.connect((self.blocks_correctiq_0, 0), (self.blocks_rotator_cc_0_0_0_1_2, 0))
        self.connect((self.blocks_correctiq_0, 0), (self.blocks_rotator_cc_0_0_1, 0))
        self.connect((self.blocks_correctiq_0, 0), (self.blocks_rotator_cc_0_0_1_0, 0))
...
def main(top_block_cls=Chan10_4M_HackRF, options=None):
